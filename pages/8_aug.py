...
from utils import load_data, df_insurance, func_running, fig_linechart, fig_vbarchart_stack
...
fig_stack_insurance = fig_vbarchart_stack(df_insu)
...
st.plotly_chart(fig_stack_insurance, use_container_width=True)
