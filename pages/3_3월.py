...
if authentication_status:
    ...
    sum_mar, sum_month = instance_chart.make_data_sum(column_select=['보험종목','영수일자'])
    ...
    company_mar, company_month = instance_chart.make_data_basic(column_select=['보험회사','영수일자'])
    product_mar, product_month = instance_chart.make_data_basic(column_select=['상품군','영수일자'])
    ...
    channel_mar, channel_month = instance_chart.make_data_basic(column_select=['소속','영수일자'])
