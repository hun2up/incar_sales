...
if authentication_status:
    ...
    instance_product_partner = SubCards(df=df_month, reference=['상품명','보험회사','담당자코드','담당자','파트너','소속'])
    lst_prod.append(instance_product_partner.make_rank_product(df=dfr_prod, select=['상품명','파트너','소속'], drop=['상품명']))
