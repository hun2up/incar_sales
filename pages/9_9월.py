...
if authentication_status:
    ...
    st.write(['보험종목','영수일자'])
    instance_chart.make_running_basic(column_select=['보험종목','영수일자'])
    st.dataframe(instance_chart.make_running_basic(column_select=['보험종목','영수일자']))
    st.write(['보험회사','영수일자'])
    instance_chart.make_running_basic(column_select=['보험회사','영수일자'])
    st.dataframe(instance_chart.make_running_basic(column_select=['보험회사','영수일자']))
    st.write(['상품군','영수일자'])
    instance_chart.make_running_basic(column_select=['상품군','영수일자'])
    st.dataframe(instance_chart.make_running_basic(column_select=['상품군','영수일자']))
