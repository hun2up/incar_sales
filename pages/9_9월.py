...
if authentication_status:
    ...
    # -------------------------------------------  매출액 기준 기본 전처리  ----------------------------------------------------
    # 보험종목별 매출액
    df_insu = fn_category(df_sep, ['보험종목','영수일자'])
    # 보험회사별 매출액
    df_company = fn_category(df_sep, ['보험회사','영수일자'])
    # 상품군별 매출액
    df_product = fn_category(df_sep, ['상품군','영수일자'])
    # 소속부문별 매출액
    df_channel = fn_category(df_sep, ['소속','영수일자'])
